  				...
  				<div class="card-body">
  					...
  					<form action="handleform" method="post">
  						<div class="form-group">
  							...
  							<small id="emailHelp" class="form-text text-muted" >Not disclosing your data</small>
  						</div>
  						...
  						<div class="form-group">
  							...
  							<input name="date" type="text" class="form-control" id="exampleInputEmail" placeholder="dd/mm/yyyy" aria-describedby="emailHelp" placeholder="Enter Name" >
  						</div>
  						
  						<div class="form-group">
  							<label for="exampleFormControlSelect1">Select Courses</label>
  							<select name="courses" class="form-control" id="exampleFormControleSelect1" multiple>
  								<option>Java</option>
